...
private.addAccount = function (account, scope) {
	...
	account.balance[constants.defToken] = account.balance[constants.defToken] || 0;
	account.u_balance[constants.defToken] = account.u_balance[constants.defToken] || 0;
...
Accounts.prototype.generateAddressByPublicKey = function (publicKey) {
	...
	var address = bignum.fromBuffer(temp).toString() + constants.addrSuffix;
	return address;
}
